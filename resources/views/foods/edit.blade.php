...
<div class="container mt-2">
         <form method="POST" action="{{ route('foods.update',['post' =>$post]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <fieldset class="mb-4 ml-3">
             <div style="font-size:2vw;padding-top: 40px;" class="mt-2 form-group">
                ...
                <div style="font-size:2vw;" class="mt-2 form-group">
                    ...
                    <input
                        ...
                        value="{{ old('store_name')?: $post->store_name }}"
                        type="text"
                        >
                ...
                <div style="font-size:2vw;" class="mt-2 form-group">
                    ...
                    <textarea style="font-size:2vw" id="body" name="body" class="form-control {{ $errors->has('body') ? 'is-invalid' : '' }}" rows="4">{{ old('body') ?: $post->body }}</textarea>
                        @if ($errors->has('body'))
                            <div class="invalid-feedback">
                                {{ $errors->first('body') }}
                            </div>
                ...
                <div style="font-size:2vw;" class="mt-2 form-group">
                    ...
                    <input
                        ...
                        value="{{ old('holiday')?: $post->holiday }}"
                        type="text"
                        >
                ...
                <div style="clear: both;" class="mt-4">
                    <button style=" margin-top:40px; margin-bottom: 30px;" type="submit" class="btn btn-primary">&nbsp;更新&nbsp;</button>
                </div>
                </fieldset>
            </form>
    </div>
